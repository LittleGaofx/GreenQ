...
function showGameScoreLayer() {
    ...
    var score_text='得分&nbsp;&nbsp;';
    score_text+=deviation_time<93000?_gameScore:"<span style='color:red;'>"+_gameScore+"</span>";
...
function shareText(score) {
    ...
    if (score <= 99) return '有点东西嘛';
    if (score <= 149) return '牛逼！';
    if (score <= 199) return 'woc 真是太牛逼了';
